...
import {
  ...
  ServerErrorResponse,
  ValidationResponse,
} from "@/interface/axios/statusResponse";
...
export function isTokenInvalid(e: AxiosError<Response401>): boolean {
  return (
    !!e.response &&
...
export function isServerError(e: AxiosError<ServerErrorResponse>): boolean {
